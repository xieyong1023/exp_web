					...
					<?php foreach ($list as $k=>$item):?>
						<li>
							<a href="<?php echo $item['url']?>" target="_blank" title="<?php echo $item['title']?>">
								<img src="<?php echo ($item['thumb']!=base_url())?$item['thumb']:base_url()."images/nopic.gif"?>" width="188" height="144"/>
							</a>
							<A href="<?php echo $item['url']?>" target="_blank" title="<?php echo $item['title']?>" class="product_name"><?php echo utf_substr($item['title'],28)?></A>
						</li>
						<?php endforeach;?>
				</ul>
