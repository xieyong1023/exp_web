					...
					<div class="cell">
						<table width="100%">
							<tbody>
								<tr>
									<td width="48">
										<a href="'.base_url('member/p').'/'.$user_detail['username'].'">
								...
								<tr>
									<td width="25%" align="center">
										<a class="nounderline">
											...
											<div class="sep3"></div>
											<a class="fade nounderline" href="'.base_url('member/p/'.$user_detail['username'].'/topics').'">我的文章</a>
										</a>
									</td>
									...
									<td width="25%" align="center">
										<a class="nounderline" href="'.base_url('member/report').'">
						...
						<table width="100%">
							<tbody>
								<tr>
									...
									<td width="10"></td>
									<td><a href="'.base_url('member/edit').'">发表新主题</a></td>
								</tr>
							</tbody>
						</table>
					</div>
					<div class="cell">
						<a href="'.base_url('member/upload').'">上传实验报告</a>
					</div>
				</div>
				<div class="sep20"></div>';
				}
