...
<?php if($tpl=='list'):?>
	...
	<th  align=left><?=lang('apply_jobs')?></th>
	<th width=80  align=left><?=lang('apply_name')?></th>
	<th width=80   align="left"><?=lang('sex')?></th>
	<th width=120   align="left"><?=lang('apply_email')?></th>
	<th width=90   align="left"><?=lang('apply_phone')?></th>
...
<?php elseif($tpl=='view'):?>
	...
	<tr>
		<td><?=lang('apply_jobs')?></td>
		<td colspan="3"><input type="text" name="jobs" id="jobs" size="85" class="validate input-text" validtip="required"  value="<?=isset($view['jobs'])?$view['jobs']:'';?>"></td>
	</tr>
	<tr>
		...
		<td><input type="text" name="name" id="name" class="validate input-text" validtip="required"  value="<?=isset($view['name'])?$view['name']:'';?>"></td>
	</tr>

    <tr>
		<td><?=lang('sex')?></td>
		<td><input type="text" name="sex" id="sex" class="input-text" value="<?=isset($view['sex'])?$view['sex']:'';?>"></td>
		<td><?=lang('apply_marray')?></td>
		<td><input type="text" name="marriage" id="marriage" class="input-text" value="<?=isset($view['marriage'])?$view['marriage']:'';?>"></td>
	</tr>
     <tr>
		<td><?=lang('apply_height')?></td>
		<td><input type="text" name="height" id="height" class="input-text" value="<?=isset($view['height'])?$view['height']:'';?>">CM</td>
		<td><?=lang('apply_address')?></td>
		<td><input type="text" name="address" id="address" class="input-text" value="<?=isset($view['address'])?$view['address']:'';?>"></td>
	</tr>
    <tr>
		<td><?=lang('apply_postcode')?></td>
		<td><input type="text" name="postcode" id="postcode" class="validate input-text" validtip="postcode"  value="<?=isset($view['postcode'])?$view['postcode']:'';?>"></td>
		<td><?=lang('apply_tel')?></td>
		<td><input type="text" name="tel" id="tel" class="input-text"  value="<?=isset($view['tel'])?$view['tel']:'';?>"></td>
	</tr>
    <tr>
		<td><?=lang('apply_email')?></td>
		<td><input type="text" name="email" id="email" class="validate input-text" validtip="email"  value="<?=isset($view['email'])?$view['email']:'';?>"></td>
		<td><?=lang('apply_phone')?></td>
		<td><input type="text" name="phone" id="phone" class="input-text"  value="<?=isset($view['phone'])?$view['phone']:'';?>"></td>
	</tr>
	<tr>
		<td><?=lang('apply_edu')?></td>
		<td colspan="3"><textarea rows="5" cols="83" class="txtarea" name="eduresume" id="eduresume"><?=isset($view['eduresume'])?$view['eduresume']:'';?></textarea></td></tr>
	<tr>
		<td><?=lang('apply_work')?></td>
		<td colspan="5"><textarea rows="5" cols="83" class="txtarea" name="workresume" id="workresume"><?=isset($view['workresume'])?htmlspecialchars($view['workresume']):'';?></textarea></td></tr>
	<tr>
