	...
	<form name="formview" id="formview" action="" method="post">
		...
		<div id="main_view" class="main_view" >
			<table cellSpacing=0 width="100%" class="content_view">
				...
				<tr>
					<td width="100"><?=lang('online_num_code')?></td>
					<td><textarea name="description" id="description" class="txtarea" cols="40" rows="5"><?=isset($view['description'])?$view['description']:'';?></textarea></td>
				</tr>
				<tr>
