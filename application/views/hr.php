		...
		<div id="main_view" class="main_view">
			<table cellSpacing=0 width="100%" class="content_view">
				...
				<tr>
					...
					<td colspan="4"><textarea rows="5" cols="80" class="txtarea" name="description" id="description"><?=isset($view['description'])?$view['description']:'';?></textarea></td>
				</tr>
				<tr>
					<td><?=lang('hr_content')?></td>
					<td colspan="5"><textarea style="width:668px;height:200px;" name="content" id="content" class="editor"><?=isset($view['content'])?htmlspecialchars($view['content']):'';?></textarea></td>
				</tr>
				<tr>
					<td><?=lang('tag')?></td>
					<td colspan="5">
				...
				<tr>
  				...
  				<tr>
					<td><?=lang('hr_age')?></td>
					<td>
						<input type="text" name="age" id="age" class="input-text" value="<?=isset($view['age'])?$view['age']:'';?>">
					</td>
					<td><?=lang('hr_sex')?></td>
					<td>
						<input type="text" name="sex" id="sex" class="input-text" value="<?=isset($view['sex'])?$view['sex']:'';?>">
					</td>
					<td><?=lang('hr_gzdy')?></td>
					<td><input type="text" name="gzdy" id="gzdy" class="input-text" value="<?=isset($view['gzdy'])?$view['gzdy']:'';?>"></td>
				</tr>
				<tr>
					<td><?=lang('hr_num')?></td>
					...
					<td><?=lang('hr_city')?></td>
					<td>
						<input type="text" name="city" id="city" class="input-text" value="<?=isset($view['city'])?$view['city']:'';?>">
					</td>
					<td><?=lang('hr_year')?></td>
					<td>
						<input type="text" name="year" id="year" class="input-text" value="<?=isset($view['year'])?$view['year']:'';?>">
					</td>
				</tr>
				<tr>
					<td><?=lang('hits')?></td>
