		...
		<div id="main_view" class="main_view" >
			<table cellSpacing=0 width="100%" class="content_view">
				<tr>
					...
					<td >
						<input type="text" name="title" id="title" size="40" class="validate input-text" validtip="required"  value="<?=isset($view['title'])?$view['title']:'';?>">
					</td>
				...
				<tr>
					<td width="100"><?=lang('navigation_category')?></td>
					<td>
						<select onchange="setUrl(this,'url')">
							<option value=""><?=lang('navigation_category')?></option>
							<?=$categorystr?>
							<option value="sitemap"><?=lang('navigation_sitemap')?></option><option value="rss"><?=lang('navigation_rss')?></option>
							<option value="http://"><?=lang('navigation_custom')?></option>
						</select>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td width="100"><?=lang('navigation_rel')?></td>
					<td>
						...
						<?=lang('navigation_me')?><input type="radio" name="rel" value="me" <?php if(isset($view['rel'])&&$view['rel']=='me'){echo 'checked';} ?>  />
					</td>
				</tr>
				<tr>
					<td width="100"><?=lang('remark')?></td>
					<td colspan="2">
						<textarea rows="3" cols="40" name="remark" id="remark" class="txtarea"><?=isset($view['remark'])?$view['remark']:'';?></textarea>
					</td>
				</tr>
				<tr>
