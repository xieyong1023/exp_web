		...
		<div id="main_view" class="main_view">
			<table cellSpacing=0 width="100%" class="content_view">
				<tr>
					...
					<td><input type="text" name="page" id="page" class="input-text" size="80" value="<?=$page?>" readOnly></td>
				</tr>
				<tr>
					<td width="50"><?=lang('content')?></td>
					<td><textarea rows="25" cols="100" name="content" id="content" class="txtarea"><?=isset($content)?htmlspecialchars($content):'';?></textarea></td>
				</tr>
			</table>
		</div>
	</form>
