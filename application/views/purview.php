	...
	<form name="formview" id="formview" action="" method="post">
		...
		<div id="main_view" class="main_view">
			<table cellSpacing=0 width="100%" class="content_view">
				<tr>
					<td width="100"><?=lang('parent')?></td>
					<td>
						<select name="parent">
							<option value="0" <?php if (isset($view['parent'])&&$view['parent'] ==0): ?>selected<?php endif; ?>><?=lang('toppurview')?></option>
							<?php if (isset($parent)): ?>
				...
				<tr>
					<td><?=lang('class')?></td>
					<td>
						<input type="text" name="class" id="class" class="validate input-text" validtip="required"  value="<?=isset($view['class'])?$view['class']:'';?>">
					</td>
				</tr>
				<tr>
					<td><?=lang('method')?></td>
					<td>
						<textarea rows="3" cols="40" name="method" id="method" class="txtarea"><?=isset($view['method'])?$view['method']:'';?></textarea>
					</td>
				</tr>
				<tr>
					<td><?=lang('status')?></td>
