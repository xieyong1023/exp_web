...
<?php foreach($purview[2] as $key=>$item):?>
	...
	<table  class="left_menu" cellpadding=0 cellspacing=0 id="purview_<?=$key?>">
		<tr>
			<td>
				<b class="mtop"><?=lang('func_'.$purview[3][$key]['class'])?></b>
			</td>
		</tr>
	<?php foreach ($item as $puritem): ?>
		<tr>
			<td onclick="seton(this,'<?=site_aurl($puritem['class'])?>');">
				<span><a href="javascript:void(0)"><?=lang('func_'.$puritem['class'])?></a></span>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
