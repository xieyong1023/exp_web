			...
			<table cellSpacing=0 width="100%" class="content_list">
				<tbody id="content_list">
					...
					<tr id="tid_<?=base64_encode($item['name'])?>">
						<td width=30>
							<input type=checkbox name="optid[]" value="<?=base64_encode($item['name'])?>">
						</td>
						<td><?=$item['name']?></td>
	...
	<form name="formview" id="formview" action="" method="post">
		...
		<div id="main" class="main"  style="padding-top:40px;">
			<table cellSpacing=0 width="100%" class="content_view">
				<tr>
					<td width="100"><?=lang('database_sql')?></td>
					<td>
						<textarea name="upgradesql" id="upgradesql"  style="width:600px;height:400px;" class="txtarea validate"  validtip="required"></textarea>
					</td>
				</tr>
				<tr>
					<td width="100"></td>
					<td><div class="func"><?php if (isset($funcstr)): ?><?=$funcstr?><?php endif; ?></div></td>
				</tr>
			</table>
		</div>
	</form>
