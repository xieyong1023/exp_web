	...
	<form name="formview" id="formview" action="" method="post">
		...
		<div id="main_view" class="main_view">
			<table cellSpacing=0 width="100%" class="content_view">
				<tr>
					<td width="100"><?=lang('func_usergroup')?></td>
					<td>
						<select name="usergroup" id="usergroup" class="validate" validtip="required">
							<option value=""><?=lang('func_usergroup')?></option>
				...
				<tr>
					...
					<td><input type="text" name="username" id="username" class="validate input-text" validtip="required" value="<?=isset($view['username'])?$view['username']:''?>"></td>
				</tr>
				<tr>
					<td><?=lang('password')?></td>
					<td><input type="password" name="password" id="password" class="validate input-text" validtip="<? if(!isset($view['id'])){echo 'required,';}?>minsize:6" value=""></td>
				</tr>
				<tr>
					<td><?=lang('email')?></td>
				...
				<tr>
					<td><?=lang('realname')?></td>
					<td><input type="text" name="realname" id="realname" class="input-text" value="<?=isset($view['realname'])?$view['realname']:''?>"></td>
				</tr>
				<tr>
					<td><?=lang('sex')?></td>
					<td>
				...
				<tr>
					<td><?=lang('mobile')?></td>
					<td><input type="text" name="mobile" id="mobile" class="input-text" value="<?=isset($view['mobile'])?$view['mobile']:''?>"></td>
				</tr>
				<tr>
					<td><?=lang('fax')?></td>
					<td><input type="text" name="fax" id="fax" class="input-text" value="<?=isset($view['fax'])?$view['fax']:''?>"></td>
				</tr>
				<tr>
					<td><?=lang('address')?></td>
					<td><input type="text" name="address" id="address" size=60 class="input-text" value="<?=isset($view['address'])?$view['address']:''?>"></td>
				</tr>
				<tr>
					<td><?=lang('status')?></td>
					<td><?=lang('status1')?>
					...
					<?=lang('status0')?>
					<input type="radio" name="status" value="0" <?php if(isset($view['status'])&&$view['status']==0){echo 'checked';} ?>  /></td>
				</tr>
			</table>
		</div>
	</form>
