		...
		<div id="main_view" class="main_view" >
			<table cellSpacing=0 width="100%" class="content_view">
				...
				<tr><td width="100"><?=lang('type_pselect')?></td>
					<td>
						<select name="type" id="type" class="validate"  validtip="required" ><option value=""><?=lang('type_pselect')?></option>
							<?php foreach($typearr as $type):?>
				...
				<tr>
					...
					<td>
						<input type="text" name="url" id="url" class="validate input-text"  validtip="required"  size="40" value="<?=isset($view['url'])?$view['url']:'';?>"></td>
					</tr>
				<tr>
					<td width="100"><?=lang('description')?></td>
					<td>
						<input type="text" name="description" id="description" class="input-text" size="40" value="<?=isset($view['description'])?$view['description']:'';?>">
					</td>
				</tr>
				<tr>
