...
#body{
	...
	height:268px;
	overflow:hidden;
	background:url(<?=base_url('images/loginbody.gif')?>) no-repeat;
	margin:150px auto;
}
...
#loginbtn{
	...
	background:url(<?=base_url('images/loginbg.gif')?>) no-repeat;
}
...
<body>
	<div id="body">
		<table border="0">
			<tr>
				<td height="60" valign="top" align="right">
					<?=lang('user_name')?></td><td valign="top" align="left">
					<input type="text" name="user_name" id="user_name" ></td></tr>
			<tr>
				<td height="40" valign="top" align="right"><?=lang('user_pass')?></td>
				<td valign="top" align="left"><input type="password" name="user_pass" id="user_pass" ></td>
			</tr>
			<tr>
				<td colspan="2" height="50" valign="top">
					<span id="msgtip"></span>
					<a href="javascript:void(0)" onclick="login()" id="loginbtn">
					<?=lang('btn_login')?></a>
				</td>
			</tr>
			<tr>
				<td colspan="2" height="20" class="footer">
					<?=lang('system_copy')?>  Powered by <a href="<?=lang('system_link')?>" target="_blank"><?=lang('system_name')?></a>
				</td>
			</tr>
		</table>
	</div>
