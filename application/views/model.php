<?php if($tpl=='list'):?>
	...
	<div id="main_head" class="main_head" style="height:70px;">
		<table class="menu">
			<tr>
				<td><a href="<?=site_aurl($tablefunc)?>" class="current"><?=lang('func_'.$tablefunc)?></a></td>
			</tr>
		</table>
	...
	<form name="formview" id="formview" action="" method="post">
		...
		<div id="main_view" class="main_view">
			<table cellSpacing=0 width="100%" class="content_view">
				<tr>
					<td width="100"><?=lang('model_varname')?></td>
					<td>
						<input type="text" name="varname" id="varname" class="validate input-text" validtip="required" value="<?=isset($view['varname'])?$view['varname']:'';?>">
					</td>
				</tr>
				<tr>
					<td><?=lang('model_issearch')?></td>
					<td>
						<?=lang('yes')?>
						<input type="radio" name="issearch" value="1" <?php if(!isset($view['issearch'])||$view['issearch']==1){echo 'checked';} ?> />
						<?=lang('no')?>
						<input type="radio" name="issearch" value="0" <?php if(isset($view['issearch'])&&$view['issearch']==0){echo 'checked';} ?>  />
					</td>
				</tr>
				<tr>
					<td><?=lang('model_isrecommend')?></td>
					<td>
						<?=lang('yes')?>
						<input type="radio" name="isrecommend" value="1" <?php if(!isset($view['isrecommend'])||$view['isrecommend']==1){echo 'checked';} ?> />
						<?=lang('no')?>
						<input type="radio" name="isrecommend" value="0" <?php if(isset($view['isrecommend'])&&$view['isrecommend']==0){echo 'checked';} ?>  />
					</td>
				</tr>
				<tr>
					<td><?=lang('status')?></td>
				...
				<tr>
					<td><?=lang('order')?></td>
					<td>
						<input type="text" name="listorder" id="listorder" value="<?php if(isset($view['listorder'])){echo $view['listorder'];}else{echo '99';} ?>" class="input-text" value="">
					</td>
				</tr>
			</table>
		</div>
