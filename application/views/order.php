	...
	<table cellSpacing=0 width="100%" class="content_list">
		<thead>
			<tr>
				...
				<th width=80   align="left"><?=lang('order_author')?></th>
				<th width=250   align="left"><?=lang('order_address')?></th>
				<th width=90   align="left"><?=lang('order_phone')?></th>
				<th width=120   align="left"><?=lang('order_createtime')?></th>
	...
	<form name="formview" id="formview" action="" method="post">
		...
		<table cellSpacing=0 width="100%" class="content_view">
			<tr>
				<td><?=lang('title')?></td>
				<td colspan="3">
					<input type="text" name="title" id="title" size="85" class="validate input-text" validtip="required"  value="<?=isset($view['title'])?$view['title']:'';?>">
				</td>
			</tr>
			<tr>
				<td><?=lang('order_author')?></td>
				<td><input type="text" name="author" id="author" class="validate input-text" validtip="required"  value="<?=isset($view['author'])?$view['author']:'';?>"></td>
      			...
      			<td><input type="text" name="phone" id="phone" class="validate input-text" validtip="required"  value="<?=isset($view['phone'])?$view['phone']:'';?>"></td>
			</tr>
			<tr>
       			<td><?=lang('apply_email')?></td>
        		<td><input type="text" name="email" id="email" class="input-text"  value="<?=isset($view['email'])?$view['email']:'';?>"></td>
				<td><?=lang('order_tel')?></td>
				<td><input type="text" name="tel" id="tel" class="input-text" value="<?=isset($view['tel'])?$view['tel']:'';?>"></td>
			</tr>
			<tr>
           		<td><?=lang('order_provinces')?></td>
            	<td><input type="text" name="provinces" id="provinces" class="input-text"  value="<?=isset($view['provinces'])?$view['provinces']:'';?>"></td>
           		<td><?=lang('order_city')?></td>
            	<td><input type="text" name="city" id="city" class="input-text" value="<?=isset($view['city'])?$view['city']:'';?>"></td>
        	</tr>
        	<tr>
            	<td><?=lang('order_address')?></td>
            	<td colspan="3">
            		<input type="text" name="address" id="address" size="60" class="validate input-text" validtip="required" value="<?=isset($view['address'])?$view['address']:'';?>">
            	</td>
        	</tr>
			<tr>
				<td><?=lang('order_description')?></td>
				<td colspan="3">
					<textarea rows="5" cols="83" class="txtarea" name="description" id="description"><?=isset($view['description'])?$view['description']:'';?></textarea>
				</td>
			</tr>
			<tr>
				<td><?=lang('order_reply')?></td>
				<td colspan="5">
					<textarea style="width:668px;height:200px;" name="content" id="content" class="editor"><?=isset($view['content'])?htmlspecialchars($view['content']):'';?></textarea>
				</td>
			</tr>
			<tr>
				<td><?=lang('order_createtime')?></td>
