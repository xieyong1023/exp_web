	...
	<form name="formview" id="formview" action="" method="post">
		...
		<div id="main_view" class="main_view">
			<table cellSpacing=0 width="100%" class="content_view">
    			...
    			<tr>
					<td><?=lang('alt')?></td>
					<td colspan="4"><input type="text" name="alt" id="alt" class="input-text" size="60"  value="<?=isset($view['alt'])?$view['alt']:'';?>"></td>
				</tr>
				<tr>
					<td><?=lang('keywords')?></td>
					<td colspan="4"><input type="text" name="keywords" id="keywords" class="input-text" size="60"  value="<?=isset($view['keywords'])?$view['keywords']:'';?>"></td>
				</tr>
				<tr>
					<td><?=lang('description')?></td>
					<td colspan="4">
						<textarea rows="5" cols="80" class="txtarea" name="description" id="description"><?=isset($view['description'])?$view['description']:'';?></textarea>
					</td>
				</tr>
				<tr>
					<td><?=lang('content')?></td>
				...
				<tr>
					...
					<td colspan="3">
						<input type="text" name="attrurl" id="attrurl" class="input-text" size="50"  value="<?=isset($view['attrurl'])?$view['attrurl']:'';?>">
						<input type="button" value="<?=lang('down_select')?>" class="btn"  onclick="uploadfile('attrurl','attrname')"></td>
					<td><?=lang('down_attrname')?></td>
					<td><input type="text" name="attrname" id="attrname" class="input-text" value="<?=isset($view['attrname'])?$view['attrname']:'';?>"></td>
				</tr>
				<tr>
				<tr>
					<td><?=lang('tag')?></td>
					<td colspan="5"><input type="text" name="tags" id="tags" size="80" class="input-text" value="<?=isset($tags)?$tags:'';?>"><?=lang('tagtip')?></td>
				</tr>
				<tr>
					...
					<td colspan="5">
						<?php foreach($recommendarr as $recommend):?>
						<?=$recommend['title']?>
						<input type="checkbox" name="recommends[]" <?php if(in_array($recommend['id'],$recommends)):?>checked<?php endif;?> value="<?=$recommend['id']?>">
						<?php endforeach;?>
					</td>
				</tr>
				<tr>
					<td><?=lang('hits')?></td>
					<td>
						<input type="text" name="hits" id="hits"  class="input-text" value="<?=isset($view['hits'])?$view['hits']:0?>"></td>
					<td><?=lang('puttime')?></td>
