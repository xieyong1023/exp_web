		...
		<div id="main_view" class="main_view">
			<table cellSpacing=0 width="100%" class="content_view">
				...
				<tr>
					<td><?=lang('keywords')?></td>
					<td colspan="4">
						<input type="text" name="keywords" id="keywords" class="input-text" size="60"  value="<?=isset($view['keywords'])?$view['keywords']:'';?>">
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td><?=lang('video_videourl')?></td>
					<td colspan="3">
						<input type="text" name="videourl" id="videourl" class="input-text" size="50"  value="<?=isset($view['videourl'])?$view['videourl']:'';?>">
						<input type="button" value="<?=lang('video_select')?>" class="btn"  onclick="uploadfile('videourl','videoname')">
					</td>
					<td><?=lang('video_videoname')?></td>
					<td>
						<input type="text" name="videoname" id="videoname" class="input-text" value="<?=isset($view['videoname'])?$view['videoname']:'';?>">
					</td>
				</tr>
				<tr>
				<tr>
