		...
		<div id="main_view" class="main_view">
			<table cellSpacing=0 width="100%" class="content_view">
				<tr>
					...
					<td>
						<input type="text" name="title" id="title" class="validate input-text" validtip="required" value="<?=isset($view['title'])?$view['title']:'';?>">
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="2"><textarea rows="3" cols="40" class="txtarea" name="remark" id="remark"><?=isset($view['remark'])?$view['remark']:'';?></textarea></td>
				</tr>
				<tr>
