	...
	<form name="formview" id="formview" action="" method="post">
		...
		<div id="main_view" class="main_view">
			<table cellSpacing=0 width="100%" class="content_view">
				<tr>
					<td><?=lang('varname')?></td>
					<td><input type="text" name="varname" id="varname" class="validate input-text" validtip="required" value="<?=isset($view['varname'])?$view['varname']:'';?>"></td>
				</tr>
				<tr>
					<td><?=lang('status')?></td>
					<td><?=lang('status1')?>
				...
				<tr>
					<td><?=lang('order')?></td>
					<td><input type="text" name="listorder" id="listorder" value="<?php if(isset($view['listorder'])){echo $view['listorder'];}else{echo '99';} ?>" class="input-text" value=""></td>
				</tr>
			</table>
		</div>
	</form>
