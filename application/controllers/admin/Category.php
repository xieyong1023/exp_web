...
class Category extends CI_Controller {
	...
	var $fields = array('parent','name','nameen','title','isexternal','externalurl','target','dir','keywords','description','content','model','thumb','alt','color','tpllist','tpldetail','pagesize','isnavigation','isdisabled','listorder');
