...
class Product extends CI_Controller {
	...
	//var $fields = array('category','title','keywords','description','content','price','spxq','gztx','xgjscs','czsm','lxwm','thumb','alt','color','isbold','hits','tpl','listorder','status');
    var $fields = array('category','title','keywords','description','content','thumb','alt','color','isbold','hits','tpl','listorder','status');
	...
	public function add(){
		...
		if($post['action']==site_aurl($this->tablefunc)){
            ...
            $data['filepath']=getfilepath($post['filepath']);
			$time = time();
			...
			$res = array(
				...
				'categoryarr'=>$this->categoryarr,
				'recommendarr'=>$this->recommendarr,
				'hxarray'=>$this->hxarray,
				'fgarray'=>$this->fgarray,
				'categoryarr'=>$this->categoryarr,
				'recommends'=>array()
			);
